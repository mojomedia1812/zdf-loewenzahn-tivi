...
- Startprüfung: meldet neuere GitHub-Releases und installiert das ZIP nach Bestätigung direkt
- Repository: liefert Kodi-kompatible Update-Metadaten über `addons.xml`
